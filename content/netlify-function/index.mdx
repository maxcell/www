...
You'll want to make sure you have installed the [Netlify CLI][netlify-cli] and have an account with Netlify.
This overall makes it easier for you when you want to develop and test *anything* with Netlify. **You will want to
be sure you have Node version 10 or higher**.

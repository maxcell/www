...
const Index = (props) => {
  return (
    <Fragment>
      ...
      <h3 className="mt-10 mb-4 text-xl font-bold uppercase tracking-wider">Latest Articles</h3>
      <ol className="ml-2 list-none list-inside">
        ...
        <li><a className="font-medium group" href="/garden">Browse all articles<RightDoubleChevron className="h-4 inline transition duration-300 ease-in-out group-hover:translate-x-2" /></a></li>
      </ol>

      <h3 className="mt-8 mb-4 text-xl font-bold uppercase tracking-wider">Speaking Engagements</h3>
      <ol className="ml-2 list-none list-inside">

...
![Minified code for my babel compiled code with no browserslist](../../../assets/babel_unset_browserslist.png)
...
![Minified code for my babel compiled code with a set browserslist](../../../assets/browserslist_set_code.png)
